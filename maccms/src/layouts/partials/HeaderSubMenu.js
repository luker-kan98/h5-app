...
const HeaderWithSubMenu = ({ mobile_title, children }) => {
  ...
  const vMenuRef = useRef();
  useOutsideAlerter(vMenuRef, setVMenuOpen);

  let version = asPath.pathname.includes("v10") ? "v10" : "v8";
  ...
  return (
    <>
      <header
        className={clsx("header", (showMenu || showSubMenu || sticky)  && "header-sticky", !showMenu && direction === 1 && "unpinned")}
        ref={headerRef}
      >
        <nav className={clsx("navbar nav-container")}>
          ...
          {/* Submenu icon */}
          <button onClick={() => setShowSubMenu(true)} className={clsx("-ml-4 md:hidden", (showMenu || showSubMenu) && "hidden")}>
            <svg width="48px" height="48px" viewBox="0 0 88 88" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="文档" transform="translate(0.000000, -94.000000)">
                  <g id="Navigation-Bar" transform="translate(0.000000, 88.000000)">
                    <g id="home_menu" transform="translate(0.000000, 6.000000)">
                      <rect id="矩形" fill="#EAEAEA" opacity="0" x="0" y="0" width="88" height="88"></rect>
                      <path d="M48.9687771,28.8535534 L48.9687771,32.8535534 L22.9687771,32.8525534 L22.9687771,57.8535534 L18.9687771,57.8535534 L18.9687771,28.8535534 L48.9687771,28.8535534 Z" fill="#05031A" transform="translate(33.968777, 43.353553) rotate(-225.000000) translate(-33.968777, -43.353553) "></path>
                    </g>
                  </g>
                </g>
              </g>
          ...
          <div className={clsx("flex items-center justify-center md:hidden grow", (showMenu || showSubMenu) && "hidden")}>
