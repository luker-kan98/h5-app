        ...
        >
          <div className="w-full flex flex-col items-start gap-[10px]">
            ...
            <ul className="doc-menu">
              <li className={clsx("doc-menu-item group", router.pathname == "/apis/collect" && "active")}>
                <Link href={`/apis/collect`} className="group-hover:text-primary text-[16px]">{t("apis.clt.s2")}</Link>
              </li>
              <li className={clsx("doc-menu-item group", router.pathname.startsWith("/apis/web-design") && "active")}>
                <Link href={`/apis/web-design`}
                      className="group-hover:text-primary text-[16px]">{t("apis.wd.s1")}</Link>
              </li>
            </ul>
          </div>
        </div>
